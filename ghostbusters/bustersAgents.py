...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for e in livingGhostPositionDistributions:
            ghostDistance = self.distancer.getDistance(pacmanPosition, e.argMax())
            if ghostDistance < closestDistance:
                closestDistance = ghostDistance
            for h in legal:
                distance = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, h), e.argMax())
